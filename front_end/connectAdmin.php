<?php
include("../back_end/connexionAdmin.php");
?>
...
<body>
<!-- Affichage d'un formulaire avec deux labels, identifiant et mot de passe -->
    <div class="container" id="containerConversion">
        <div class="row">
            <h3>Connexion d'un administrateur</h3>
        </div>
        <!-- Redirection vers testco qui va tester la viabilité des informations -->
